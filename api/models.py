...
class TwilioMessage(models.Model):
    """ A Twilio Message"""
    ApiVersion = models.CharField(max_length=100, blank=True)
    MessagingServiceSid = models.CharField(max_length=40, blank=True)
    SmsSid = models.CharField(max_length=40, blank=True)
    SmsStatus = models.CharField(max_length=40, blank=True)
    SmsMessageSid = models.CharField(max_length=40, blank=True)
    NumSegments = models.IntegerField( blank=True)
    From = models.CharField(max_length=40, blank=True)
    ToState = models.CharField(max_length=5, blank=True)
    MessageSid = models.CharField(max_length=40, blank=True)
    AccountSid = models.CharField(max_length=40, blank=True)
    ToZip = models.CharField(max_length=20, blank=True)
    FromCountry = models.CharField(max_length=100, blank=True)
    ToCity = models.CharField(max_length=100, blank=True)
    FromCity = models.CharField(max_length=100, blank=True)
    To = models.CharField(max_length=40, blank=True)
    FromZip = models.CharField(max_length=100, blank=True)
    Body = models.CharField(max_length=40, blank=True)
    ToCountry = models.CharField(max_length=100, blank=True)
    FromState = models.CharField(max_length=100, blank=True)
    NumMedia = models.IntegerField( blank=True)
